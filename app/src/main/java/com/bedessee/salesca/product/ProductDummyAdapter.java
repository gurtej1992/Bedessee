...
public class ProductDummyAdapter extends RecyclerView.Adapter<ProductDummyAdapter.ViewHolder>{
    ...
    public ProductDummyAdapter(Context context, ArrayList<Product> list,int[] screenDimens) {
        mContext = context;
...
//                }
        ...
        if (!isBusy) {
            ...
            View.OnClickListener quickListener = v -> {
                ...
                MixPanelManager.trackButtonClick(mContext, "Button Click: view product");
            };
            ...
            holder.mImageView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    Utilities.shareImage(mContext, "file://" + filePath);
                    return true;
                }
            });
        } else {
...
//                );
            ...
            holder.mBtnAddToCart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (StoreManager.isStoreSelected()) {
                        ...
                        MixPanelManager.trackButtonClick(mContext, "Button Click: Add to cart");
                        if (product.getPopUpPriceFlag().equalsIgnoreCase("Y")) {

                            AlertDialog.Builder qtyBuilder = new AlertDialog.Builder(mContext);
                            final View view = LayoutInflater.from(mContext).inflate(R.layout.dialog_product_qty, null, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            mItemBody = itemView.findViewById(R.id.item_body);
            mImageView = itemView.findViewById(R.id.product_image);
           mTextViewBrand = itemView.findViewById(R.id.textView_brand);
           mTextUom = itemView.findViewById(R.id.textView_uom);
            mTextUomUnit = itemView.findViewById(R.id.textView_unit_uom);
           mTextPriceUnit = itemView.findViewById(R.id.textView_unit_price);
            mBtnAddToCart = itemView.findViewById(R.id.btnAddToCart);
            mQtySelector = itemView.findViewById(R.id.list_item_qty_selector);
           mQtySelector.showType(showType);

            mTextUomUnit.setVisibility(showUom ? View.VISIBLE : View.GONE);
           mTextPriceUnit.setVisibility(showUom ? View.VISIBLE : View.GONE);

       add = itemView.findViewById(R.id.add);
            //  viewHolder.product_type = view.findViewById(R.id.product_type);
            add_count = itemView.findViewById(R.id.add_count);
        }
    }
