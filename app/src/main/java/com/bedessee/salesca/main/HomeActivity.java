...
//        }
       ...
       menu.setOnClickListener(view -> {
        ...
        if(directory != null) {
            ...
            if (!file.exists()) {
                MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Top menu: DAILY UPDATE");
            ...
            if (file.exists()) {
                ...
                findViewById(R.id.btn_sell_sheets).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Sell sheets");
                        startActivityForResult(new Intent(HomeActivity.this, SellSheetsDialog.class), SellSheetsDialog.RESULT_CODE);
                    }
                });
    ...
    protected void onPostResume() {
        ...
        if(directory != null) {
            ...
            if (file.exists()) {
                ...
                Timber.d("HomeActivity onPostResume");
            }
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (resultCode) {
            ...
            case ShoppingCartDialog.RESULT_CODE_CHECKED_OUT: {
                ShoppingCart.setCurrentOrderId(HomeActivity.this, null);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.select_store:
                        mShowBalanceDialog = true;
                        MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Top menu: Select Store");
                        StoreSelector.open(HomeActivity.this);
                    break;
                    case R.id.shopping_cart:
                        if (StoreManager.isStoreSelected()) {
                            MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Top menu: Shopping Cart");
                            startActivityForResult(new Intent(HomeActivity.this, ShoppingCartDialog.class), ShoppingCartDialog.REQUEST_CODE);
                        } else {
                            MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Top menu: Select Store -NO STORE SELECTED");
                            Toast.makeText(HomeActivity.this, "Please select store to continue.", Toast.LENGTH_SHORT).show();
                        }
                    break;
                }
            }
        ...
        /* Set version # */
        mMenu.findItem(R.id.version).setTitle("V " + Utilities.getVersionString(HomeActivity.this));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        final SharedPrefsManager sharedPrefsManager = new SharedPrefsManager(HomeActivity.this);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.past_order:
                final Intent pastSalesIntent = new Intent(HomeActivity.this, PastOrderActivity.class);
            ...
            case R.id.exit:
                MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Top menu: EXIT APP");
                finish();
                System.exit(0);
                return true;

            case R.id.version:
                MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Top menu: APP VERSION");
    ...
    private void openBackOrderActivity() {
        final Intent backOrderIntent = new Intent(HomeActivity.this, BackOrderActivity.class);
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    if (reportsSpinnerInit && !reportsOpen && position > 0) {
                        ...
                        if (store != null && store.getStatementUrl() != null) {
                            ...
                            ReportsUtilities.Companion.openReportMenu(HomeActivity.this, reportsMenu, store);
                            reportsOpen = false;
                        } else {
                            Utilities.shortToast(HomeActivity.this, "Please select a store first");
                            clearReportMenu();
                        }
                    } else {
    ...
    private void checkForExistingSavedOrder() {
        final String savedOrderId = ShoppingCart.getCurrentOrderId(HomeActivity.this);
        ...
        if (!TextUtils.isEmpty(savedOrderId)) {
            ...
            final ShoppingCart shoppingCart = ShoppingCart.getSavedOrder(HomeActivity.this, savedOrderId);
            ...
            if (!shoppingCart.getProducts().isEmpty()) {
                GenericDialog.Companion.newInstance(getString(R.string.in_progress_detected, storeName, numProducts), getString(R.string.resume_order_message), new GenericDialog.OnClickListener() {
                    ...
                    public void onClick(@NotNull DialogFragment dialog) {
                        /* Load saved order */
                        MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Resume saved order? YES");
                        ...
                        if (cursor != null && cursor.moveToFirst()) {
                            ...
                            GenericDialog.Companion.outstandingDialogInstance(
                                    HomeActivity.this, store.getOutstandingBalanceDue(),
                    ...
                    @Override
                    public void onClick(@NotNull DialogFragment dialog) {
                        MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Resume saved order? NO");
                        ShoppingCart.setCurrentOrderId(HomeActivity.this, null);
                    }
                }).show(getSupportFragmentManager(), TAG);
            }
    ...
    private void loadUpcDialog(final String number) {
        ...
        LoaderManager.LoaderCallbacks<Cursor> loaderCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
            ...
            public Loader<Cursor> onCreateLoader(int id, Bundle args) {
                ...
                return new CursorLoader(HomeActivity.this, Contract.Product.CONTENT_URI, null, Contract.ProductColumns.COLUMN_UPC + " LIKE '%" + number + "%'", null, null);
            }
            ...
            GenericDialog.Companion.outstandingDialogInstance(
                    ...
                    new GenericDialog.OnDismissListener() {
                        ...
                        public void onDismiss() {
                            ...
                            //    ReportsUtilities.Companion.openFirstDefaultOpenReport(HomeActivity.this, store);
                            }
                        }
                    }).show(getSupportFragmentManager(), TAG);
            mShowBalanceDialog = false;
    ...
    private void selectItem(final int position) {
        switch (position) {
            case 0:
                MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Left Menu: Products");
                switchFragment(ProductFragment.getInstance(), ProductFragment.TAG);
            break;
            case 1:
                MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Left Menu: Brands");
                switchFragment(BrandFragment.getInstance(), BrandFragment.TAG);
            break;
            case 2:
                MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Left Menu: Categories");
    ...
    private void upcClicked() {
        MixPanelManager.trackButtonClick(HomeActivity.this, "Button click: Top menu: UPC");
        DialogNumberPad.Companion.newInstance("UPC Search", new DialogNumberPad.OnStringSelectedListener() {
            ...
            public void onSelected(@NotNull String value) {
                if (value.length() > 2) {
                    ...
                    Toast.makeText(HomeActivity.this, "Please enter minimum 3 digits", Toast.LENGTH_SHORT).show();
                }
            }
        }, "").show(getSupportFragmentManager(), TAG);
    }
